...
.login-page {
    ...
    .bg {
        background: url('@/assets/e69fba590f8e2da71287a6f98a6e1141_720.png') no-repeat 50% center / 240px auto,
            url('@/assets/c0438a7e8559a785c1aba9e0e8e87c19_720.png') no-repeat center / cover;
